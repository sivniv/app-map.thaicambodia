      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="mt-8 border-t border-gray-200 pt-6">
          ...
          <div className="grid grid-cols-1 gap-3">
            <Link
              href="/"
              className="block p-3 bg-white rounded-lg shadow hover:shadow-md transition-shadow border border-gray-200"
            >
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-gray-500">Latest conflict monitoring updates</p>
                </div>
              </div>
            </Link>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-sm text-gray-500">System monitoring and configuration</p>
                </div>
              </div>
            </Link>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-gray-400">
            Thailand-Cambodia Conflict Monitor • Error 404
          </p>
        </div>
      </div>
    </div>
